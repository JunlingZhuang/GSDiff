...
from gsdiff.heterhouse_56_11 import *
from gsdiff.utils import *
from itertools import cycle

'''This script is used to simply train an edge prediction model for the validation phase of the first phase boundary constraint node generation model.'''
