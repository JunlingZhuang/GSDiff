...
'''This script is used to simply train an edge prediction model for the validation phase of the first phase no constraint node generation model.'''
...
'''create output_dir'''
output_dir = 'outputs/unconst-edge-selfsup/'
